...
async def create_url_post(
    ...
    db.refresh(db_url)
    return RedirectResponse("/alfred/dashboard", status_code=status.HTTP_302_FOUND)
...
async def delete_url(
    ...
    db.delete(url_model)
    db.commit()
    return RedirectResponse("/alfred/dashboard", status_code=status.HTTP_307_TEMPORARY_REDIRECT)